...
=> Helpers.Utf8ToString(CodepointToUTF8(codepoint, byteSize));
	...
	[Obsolete("TextCodepointsToUTF8_ has been renamed to: LoadUTF8")] //TODO (Ken) REMOVE
	public static string? TextCodepointsToUTF8_(int* codepoints, int length) => null;

	public static string LoadUTF8_(int* codepoints, int length)
=> Helpers.Utf8ToString(LoadUTF8(codepoints, length));
